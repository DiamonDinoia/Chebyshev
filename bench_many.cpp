...
int main() {
  ...
  constexpr bool run_constexpr_benchmarks = false;

  // Define the number of points to benchmark
  // Change this to 1024 or 1000 to run specific set of benchmarks
  constexpr size_t num_points = 1000; // Or 1000

  // Data structures for the chosen number of points
  std::array<double, num_points> random_points{};
  std::array<double, num_points> output{};

...
int main() {
    ...
    std::cout << "\nError-Driven (double, RUNTIME Epsilon=" << std::scientific << std::setprecision(2)
              << eps_double_runtime << ", MaxN=" << MAX_N_DOUBLE_C17 << ", EvalPoints=" << EVAL_POINTS_DOUBLE_C17
              << " - C++17+):\n";
    ...
    check_errors(my_func_double, poly_runtime_d_eps, domain_a1, domain_b1,
                 "my_func_double (runtime eps, compile-time max_n, eval_pts)");
    ...
    std::cout << "\nError-Driven (float, RUNTIME Epsilon=" << std::scientific << std::setprecision(2)
              << eps_float_runtime << ", MaxN=" << MAX_N_FLOAT_C17 << ", EvalPoints=" << EVAL_POINTS_FLOAT_C17
    ...
    check_errors(my_func_float, poly_runtime_f_eps, domain_a2, domain_b2,
                 "my_func_float (runtime eps, compile-time max_n, eval_pts, iters)");
    ...
    std::cout << "\nError-Driven (complex, RUNTIME Epsilon=" << std::scientific << std::setprecision(2)
              << eps_complex_runtime << ", MaxN=" << MAX_N_COMPLEX_C17 << ", EvalPoints=" << EVAL_POINTS_COMPLEX_C17
              << " - C++17+):\n";
    ...
    check_errors(my_func_complex, poly_runtime_c_eps, domain_a3, domain_b3,
                 "my_func_complex (runtime eps, compile-time max_n, eval_pts)");
    ...
    auto poly_compiletime_d_eps =
        poly_eval::make_func_eval<COMPILE_TIME_EPS, COMPILE_TIME_MAX_N, COMPILE_TIME_EVAL_POINTS>(my_func_double,
                                                                                                  domain_a4, domain_b4);
    std::cout << "\nError-Driven (double, COMPILE-TIME Epsilon=" << std::scientific << std::setprecision(2)
              << COMPILE_TIME_EPS << ", MaxN=" << COMPILE_TIME_MAX_N << ", EvalPoints=" << COMPILE_TIME_EVAL_POINTS
              << " - C++20+):\n";
    ...
    std::cout << "  Actual at 0.0:    " << my_func_double(0.0) << std::endl;
    check_errors(my_func_double, poly_compiletime_d_eps, domain_a4, domain_b4,
                 "my_func_double (compile-time eps, max_n, eval_pts)");
#else
